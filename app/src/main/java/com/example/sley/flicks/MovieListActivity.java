package com.example.sley.flicks;
...
import com.example.sley.flicks.models.Config;
import com.example.sley.flicks.models.Movie;
        ...
        client.get(url, params, new JsonHttpResponseHandler(){
            ...
            public void onSuccess(int statusCode, Header[] headers, JSONObject response) {
                try {
                    ...
                    logError("Failed parsing configuartion", e, true);
                }
            }
